...
class ProductPaymentedBuyer extends StatefulWidget {
  const ProductPaymentedBuyer({Key? key}) : super(key: key);

  @override
  State<ProductPaymentedBuyer> createState() => _ProductPaymentedBuyerState();
}

class _ProductPaymentedBuyerState extends State<ProductPaymentedBuyer> {
