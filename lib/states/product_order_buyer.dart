...
class ProductOrderBuyer extends StatefulWidget {
  const ProductOrderBuyer({Key? key}) : super(key: key);

  @override
  State<ProductOrderBuyer> createState() => _ProductOrderBuyerState();
}

class _ProductOrderBuyerState extends State<ProductOrderBuyer> {
            ...
            itemBuilder: (context, index) => Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ShowButton(
                        label: 'ยกเลิกรายการสั่งสินค้า',
                        pressFunc: () {
                          MyDialog(context: context).actionDialog(
                              title: 'ยืนยันการยกเลิก',
                              message:
                                  'ยืนยันยกเลิก การสั่งซื้อจากร้าน ${sellerUserModels[index].name} ใช่ไหมครับ',
                              label1: 'ยืนยัน',
                              label2: 'ไม่ยืนยัน',
                              presFunc1: () {
  ...
  Future<void> processUpdateStatus({required String docIdOrder}) async {
